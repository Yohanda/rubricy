...
if(!$_POST) {
	?>
<form enctype="multipart/form-data" class="formoid-metro-cyan" style="background-color:#ffffff;font-size:14px;font-family:'Roboto',Arial,Helvetica,sans-serif;color:#34495E;max-width:480px;min-width:150px" method="post" action="<?php $_SERVER['PHP_SELF']; ?>"><div class="title"><h2>Register</h2></div>
	...
	<div class="item-cont"><div class="large"><span><select name="gender" required="required">

		<option value="0">Male</option>
		<option value="1">Female</option></select><i></i><span class="icon-place"></span></span></div></div>
...
<div class="submit"><input type="submit" value="Submit"/></div></form><br /><br />
<?php
} else {
...
$file_dir = "C:\\xampp\\htdocs\\rubicy\\user\\".$data['id_row'];
mkdir($file_dir, 0777);
...
//print "type : ".$file_array['type']; echo"<br>";
	...
	$dir = substr($file_dir."\\".$file_array['name'],23);
